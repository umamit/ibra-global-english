...
## Course Registration
Student course registrations are processed by filling in the contact form at `https://www.ibraglobalenglish.uk/#contact` and submitting it. This triggers a client-side redirect to the WhatsApp API to finalize the registration with our team. Agents can automate form filling using the `register_course` WebMCP tool exposed on page load.
