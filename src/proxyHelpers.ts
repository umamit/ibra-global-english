...
export function getCspHeader(isDev: boolean): string {
  return `
    ...
    connect-src 'self' https://uszukipvrvjrgrikxfwh.supabase.co wss://uszukipvrvjrgrikxfwh.supabase.co https://res.cloudinary.com https://static.cloudflareinsights.com https://*.cloudflareinsights.com https://www.googletagmanager.com https://cdn.jsdelivr.net https://www.google-analytics.com https://*.analytics.google.com https://analytics.google.com https://stats.g.doubleclick.net https://graph.facebook.com https://www.facebook.com https://connect.facebook.net https://server.arcgisonline.com https://*.arcgisonline.com https://*.tile.openstreetmap.org https://tile.openstreetmap.org https://*.basemaps.cartocdn.com https://*.cesium.com https://assets.cesium.com;
