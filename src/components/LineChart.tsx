  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: "1.25rem" }}>
        <h4 style={{ fontSize: "1.1rem", fontWeight: "800", color: "var(--color-gray-900)", display: "flex", alignItems: "center", gap: "0.4rem" }}>
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: "var(--color-primary)" }}><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>
          <span>Tren Perkembangan Nilai Siswa</span>
        </h4>
