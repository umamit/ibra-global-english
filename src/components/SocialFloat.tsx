...
export default function SocialFloat() {
  ...
  return (
    <div className={`social-float-group ${isOpen ? "expanded" : ""}`}>
      {/* Expandable Children Menu */}
      <div className="social-float-children">
        {/* Facebook */}
        <a 
          href="https://www.facebook.com/IbraGlobalEnglish" 
        ...
        {/* Instagram */}
        <a 
          href="https://www.instagram.com/ibraglobalenglish/" 
      ...
      <button 
        type="button" 
        className="social-float-trigger" 
        onClick={() => setIsOpen(!isOpen)}
        aria-label={isOpen ? "Tutup Menu Sosial" : "Buka Menu Sosial"}
      >
        <svg 
          className={`trigger-icon ${isOpen ? "active" : ""}`} 
