...
export default function FluidCanvas() {
  ...
  return (
    <div ref={containerRef} style={{ width: "100%", height: "100%", position: "absolute", top: 0, left: 0, zIndex: 0, overflow: "hidden", opacity: 0.35, pointerEvents: "none", background: "transparent" }}>
