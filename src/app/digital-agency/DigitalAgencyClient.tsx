  ...
  return (
    <div className={styles.pageWrapper} ref={containerRef}>
      ...
      <main>
        ...
        {/* ── Keunggulan Section (Full Bleed Edge-to-Edge) ── */}
        ...
        {/* ── Paket Harga Section (Full Bleed Edge-to-Edge White #ffffff) ── */}
        ...
        {/* ── FAQ Section (Full Bleed Edge-to-Edge Soft Neutral #f4f6f8) ── */}
        ...
        {/* ── Order/Contact Form Section (Full Bleed Edge-to-Edge White #ffffff) ── */}
