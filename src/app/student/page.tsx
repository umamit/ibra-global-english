...
export default function StudentPortal() {
  ...
  const [activeTab, setActiveTab] = useState<string>("dashboard"); // "dashboard", "modules", "achievements", "lms", "speaking"
  ...
  const [lmsSubTab, setLmsSubTab] = useState<string>("materi"); // 'materi' or 'tugas'
