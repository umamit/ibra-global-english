...
export default function AdminGalleryPage() {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (ev: ProgressEvent<FileReader>) => setPreview(ev.target?.result as string);
  ...
  const catColor = (c: string): string => {
    const map: Record<string, string> = { Kegiatan: "var(--color-primary)", Prestasi: "#f59e0b", Fasilitas: "#8b5cf6", "Kelas Online": "#22c55e" };
