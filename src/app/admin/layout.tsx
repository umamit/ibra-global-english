    ...
    <div className={`dashboard-container ${mobileOpen ? "sidebar-open" : ""}`}>
      ...
      >
        ...
        <nav className="sidebar-nav">
          ...
          <div className="sidebar-group">
            <button
              ...
              className={`sidebar-group-toggle ${["/admin/whatsapp", "/admin/announcements", "/admin/rag", "/admin/landing-page", "/admin/letters", "/admin/kemitraan"].includes(pathname) ? "active-parent" : ""}`}
            >
            ...
            <div className={`sidebar-group-items ${openGroups.komunikasi ? "expanded" : ""}`}>
              ...
              <Link href="/admin/kemitraan" className={`sidebar-sub-link ${isActive("/admin/kemitraan") ? "active" : ""}`} onClick={() => setMobileOpen(false)}>
                <span className="bullet"></span>
                <span>Kemitraan & Proposal</span>
              </Link>
        ...
        <div className="sidebar-footer" style={{ padding: "1rem", textAlign: "center" }}>
          <span style={{ fontSize: "0.7rem", color: "var(--color-gray-400)" }}>Admin Dashboard v3.13.47</span>
        </div>
      </aside>
