...
export default function AdminCalendar() {
  ...
  const handleSaveAiDraft = async () => {
    ...
    try {
      ...
      setStatusMsg({ type: "success", text: `✓ Berhasil menyimpan ${aiDraftSchedules.length} jadwal hasil penyusunan AI!` });
  ...
  return (
    <div>
      ...
      {aiPromptModalOpen && (
        <div className="portal-modal-overlay" onClick={() => { if (!aiLoading) setAiPromptModalOpen(false); }}>
          <div className="portal-modal" style={{
            maxWidth: "650px",
            padding: "2rem",
            animation: "slideIn 0.2s ease"
            ...
            {aiDraftSchedules.length === 0 ? (
              <form onSubmit={handleGenerateAiDraft}>
                ...
                <div style={{ display: "flex", justifyContent: "flex-end", gap: "0.5rem" }}>
                  <button type="button" className="btn-portal-outline" onClick={() => setAiPromptModalOpen(false)} disabled={aiLoading}>
                    Batal
                  </button>
              ...
              <div>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <div style={{ display: "flex", gap: "0.5rem" }}>
                    <button type="button" className="btn-portal-outline" onClick={() => { setAiDraftSchedules([]); setAiPromptModalOpen(false); }} disabled={loading}>
                      Batal
                    </button>
