    ...
    <div>
      ...
      <div className="dashboard-topbar">
        ...
        <div className="topbar-user">
          <button
            onClick={() => { fetchDeviceStatus(); fetchLogs(); }}
          ...
          <form onSubmit={handleSendManual}>
            <div style={{ marginBottom: "1rem" }}>
              ...
              <p style={{ fontSize: "0.75rem", color: "var(--color-gray-400)", marginTop: "0.35rem" }}>
                Gunakan format internasional tanpa tanda + (misal: 628...)
              </p>
            </div>
            ...
            {sendResult && (
              <div style={{
                ...
                fontSize: "0.83rem",
                fontWeight: "600",
                backgroundColor: sendResult.sentReal ? "#f0fdf4" : sendResult.status === "SIMULATED" ? "#fffbeb" : "#fef2f2",
                color: sendResult.sentReal ? "#166534" : sendResult.status === "SIMULATED" ? "#92400e" : "#991b1b",
                border: `1px solid ${sendResult.sentReal ? "#bbf7d0" : sendResult.status === "SIMULATED" ? "#fde68a" : "#fecaca"}`
              }}>
                {sendResult.sentReal
                  ...
                  : `❌ Gagal mengirim: ${sendResult.error || "Periksa konfigurasi token Fonnte."}`}
              </div>
            )}
