...
interface Props {
  ...
  formPeriod: string;
  setFormPeriod: (v: string) => void;
  formType: string;
  setFormType: (v: string) => void;
  formRevenue: string | number;
  setFormRevenue: (v: string) => void;
  formTaxDue: string | number;
  setFormTaxDue: (v: string) => void;
  formStatus: string;
  setFormStatus: (v: string) => void;
  formPaymentDate: string;
  setFormPaymentDate: (v: string) => void;
  formNtpn: string;
  setFormNtpn: (v: string) => void;
  formBpe: string;
  setFormBpe: (v: string) => void;
        ...
        <form onSubmit={handleAddRecord} style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "1.25rem" }}>
          <div>
            ...
            <input
              type="number"
              value={formYear}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormYear(e.target.value)}
          ...
          <div>
            ...
            <select
              value={formPeriod}
              onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setFormPeriod(e.target.value)}
              className="portal-input"
              style={{ height: "42px" }}
            >
          ...
          <div>
            ...
            <input
              type="number"
              value={formRevenue}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormRevenue(e.target.value)}
              placeholder="Rp"
              className="portal-input"
              required
            />
          ...
          <div>
            ...
            <input
              type="number"
              value={formTaxDue}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormTaxDue(e.target.value)}
              placeholder="Rp"
              className="portal-input"
              required
            />
          ...
          <div>
            ...
            <select
              value={formStatus}
              onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setFormStatus(e.target.value)}
              className="portal-input"
              style={{ height: "42px" }}
            >
          ...
          <div>
            ...
            <input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormPaymentDate(e.target.value)}
              className="portal-input"
            />
          </div>
          ...
          <div>
            ...
            <input
              type="text"
              value={formNtpn}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormNtpn(e.target.value)}
          ...
          <div>
            ...
            <input
              type="text"
              value={formBpe}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormBpe(e.target.value)}
