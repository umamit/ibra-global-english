...
interface Props {
  ...
  assetGroup: string;
  setAssetGroup: (v: string) => void;
  assetPurchaseDate: string;
  setAssetPurchaseDate: (v: string) => void;
  assetPurchasePrice: string;
  setAssetPurchasePrice: (v: string) => void;
  assetsSummary: AssetsSummary;
  formatRupiah: (value: number) => string;
  calculateDepreciation: (purchasePrice: number, purchaseDate: string, group: string) => DepreciationResult;
  handleAddAsset: React.FormEventHandler<HTMLFormElement>;
          ...
          <form onSubmit={handleAddAsset} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            ...
            <div className="form-grid" style={{ gap: "1rem", marginBottom: 0 }}>
              <div>
                ...
                <select
                  value={assetGroup}
                  onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setAssetGroup(e.target.value)}
                  className="portal-input"
                  style={{ height: "42px" }}
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setAssetPurchaseDate(e.target.value)}
                  className="portal-input"
                  required
                />
              </div>
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setAssetPurchasePrice(e.target.value)}
