...
export default function AdminRealtimeToasts({ newRegToast, setNewRegToast, newTestToast, setNewTestToast }: RealtimeToastProps) {
  ...
  return (
    <>
      {newRegToast && (
        <div role="alert" aria-live="polite" style={{ ...toastBase, top: "24px", background: "linear-gradient(135deg, #1a2a3a 0%, #0f1f2d 100%)", color: "#fff", boxShadow: "0 8px 32px rgba(0,0,0,0.35), 0 0 0 1px rgba(99,202,183,0.25)" }}>
      ...
      {newTestToast && (
        <div role="alert" aria-live="polite" style={{ ...toastBase, top: newRegToast ? "110px" : "24px", background: "linear-gradient(135deg, #1a2d1a 0%, #0f1f0f 100%)", color: "#fff", boxShadow: "0 8px 32px rgba(0,0,0,0.35), 0 0 0 1px rgba(99,183,99,0.25)", transition: "top 0.3s ease" }}>
