...
export default function TabSwitcher({ activeTab, setActiveTab, students, parents, registrations, fetchRegistrations }: Props) {
  ...
  const badgeStyle = (tab: string, bgActive: string, bgInactive: string, colorActive: string, colorInactive: string): React.CSSProperties => ({
    fontSize: "0.75rem",
