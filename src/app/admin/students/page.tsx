...
export default function StudentManagement() {
  ...
  const [waFeedback, setWaFeedback] = useState<{ id: string | null; success: boolean | null; msg: string }>({ id: null, success: null, msg: "" });

  // Approve: update status + auto-insert ke students + kirim WA via simulator
