...
export async function generateFromGroq() {
  ...
  for (let attempt = 1; attempt <= 3; attempt++) {
    try {
      ...
      const prompt = `You are a Harvard-educated CEFR-certified English language assessment expert with 20 years of experience in designing standardized English proficiency tests. Generate exactly 20 multiple-choice English placement test questions on the topic of "${randomTopic}".\n\nDistribution must be EXACTLY:\n- 4 questions: A1 (beginner, simple vocabulary & basic grammar)\n- 4 questions: A2 (elementary, everyday expressions)\n- 4 questions: B1 (intermediate, familiar topics)\n- 4 questions: B2 (upper-intermediate, complex sentences)\n- 4 questions: C1 (advanced, nuanced language & academic vocabulary)\n\nRules:\n- All questions and answer options MUST be in English\n- Each question has exactly 4 options, only 1 is correct (score: 1), others score: 0\n- Questions must test grammar, vocabulary, or reading comprehension\n- Output ONLY a raw JSON array of 20 objects. No markdown, no explanation.\n\nFormat: [{"id":"1","category":"A1","question":"...","options":[{"text":"...","score":1},{"text":"...","score":0},{"text":"...","score":0},{"text":"...","score":0}]}]`;
